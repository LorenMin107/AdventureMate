...
const geocoder = mbxGeocoding({ accessToken: config.mapbox.token }); // initialize the geocoding service with the token from config
...
module.exports.index = async (req, res) => {
  try {
    ...
    logError('Failed to fetch campgrounds data', error, {
...
module.exports.createCampground = async (req, res, next) => {
  ...
  logInfo('Campground created successfully', {
...
module.exports.searchCampgrounds = async (req, res) => {
  ...
  try {
    ...
    logError('Error during campground search', error, {
      search,
      userId: req.user?._id,
    });
