...
router.get('/campgrounds', authenticateJWT, requireAuth, canManageCampgrounds, ownerCampgrounds.getOwnerCampgrounds);
...
router.get('/campgrounds/:id', authenticateJWT, requireAuth, canManageCampgrounds, ownerCampgrounds.getOwnerCampground);
...
router.delete('/campgrounds/:id', authenticateJWT, requireAuth, canManageCampgrounds, ownerCampgrounds.deleteCampground);

// Owner Campground Booking Management
router.get('/campgrounds/:id/bookings', authenticateJWT, requireAuth, canManageCampgrounds, ownerCampgrounds.getCampgroundBookings);
router.patch('/campgrounds/:id/bookings/:bookingId', authenticateJWT, requireAuth, canManageCampgrounds, ownerCampgrounds.updateBookingStatus);
