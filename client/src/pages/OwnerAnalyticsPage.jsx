 ...
 * Provides comprehensive analytics and reporting for campground owners
 */
const OwnerAnalyticsPage = () => {
  ...
  const { data: analyticsData, isLoading, error: fetchError, refetch } = useOwnerAnalytics({
  ...
  return (
    <div className="owner-analytics">
      ...
      <div className="owner-page-header">
        <div className="header-content">
          <div>
            ...
            <p>Track your campground performance and insights</p>
          </div>
      ...
      <div className="analytics-section">
        <h2>Overview - {getPeriodLabel(selectedPeriod)}</h2>
            ...
            <div className="stat-content">
              ...
              <div className="stat-change">
                <span className={bookings.change >= 0 ? 'positive' : 'negative'}>
                  {bookings.change >= 0 ? '↗' : '↘'} {formatPercentage(Math.abs(bookings.change))}
                </span>
                <span className="change-label">vs previous period</span>
              </div>
            </div>
            ...
            <div className="stat-content">
              ...
              <div className="stat-change">
                <span className={overview.occupancyChange >= 0 ? 'positive' : 'negative'}>
                  {overview.occupancyChange >= 0 ? '↗' : '↘'} {formatPercentage(Math.abs(overview.occupancyChange))}
                </span>
                <span className="change-label">vs previous period</span>
              </div>
            </div>
          ...
          <div className="analytics-card">
            ...
            <div className="metrics-list">
              ...
              <div className="metric-item">
                ...
                <span className="metric-value">{(bookings.averageDuration || 0).toFixed(1)} days</span>
              </div>
              <div className="metric-item">
                <span className="metric-label">Cancellation Rate</span>
                <span className="metric-value">{formatPercentage(bookings.cancellationRate)}</span>
              </div>
              <div className="metric-item">
                <span className="metric-label">Repeat Customer Rate</span>
                <span className="metric-value">{formatPercentage(bookings.repeatCustomerRate)}</span>
              </div>
            </div>
          </div>
        </div>
